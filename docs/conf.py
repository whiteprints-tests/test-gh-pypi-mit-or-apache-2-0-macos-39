...
project = "test gh-pypi mit-or-apache-2-0 macos 3.9"
...
release = metadata.version("test_gh_pypi_mit_or_apache_2_0_macos_39")
    ...
    "icon_links": [
        {
            ...
            "url": (
                "https://github.com/"
                "whiteprints-tests/"
                "test-gh-pypi-mit-or-apache-2-0-macos-39"
            ),
